...
public class ReportPostAdapter extends RecyclerView.Adapter<ReportPostAdapter.IssueViewHolder>{
...
//    public CommentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public static class IssueViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(int position, ReportPostAdapter.OnItemPressedListener listener) {
