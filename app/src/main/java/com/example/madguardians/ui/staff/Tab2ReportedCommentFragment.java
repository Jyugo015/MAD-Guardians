...
//delete havent do
public class Tab2ReportedCommentFragment extends BaseTab2Fragment<Helpdesk> implements RecycleViewReportedCommentAdapter.OnReportedCommentActionListener{
    private RecycleViewReportedCommentAdapter adapter;
    private NotificationUtils notificationUtils;
    private List<Helpdesk> reportedCommentList = new ArrayList<>();
    private String staffId;
    public Tab2ReportedCommentFragment (){
...
//
//        db.collection("helpdesk")
//                .whereEqualTo("helpdeskStatus", "pending") // Filter for pending status
//                .whereGreaterThan("commentId", "") // Ensure commentId is not empty
//                .get()
//                .addOnCompleteListener(task -> {
//                    if (task.isSuccessful() && task.getResult() != null) {
//                        List<Helpdesk> helpdeskReportedCommentList = new ArrayList<>();
...
//
//                        for (QueryDocumentSnapshot document : task.getResult()) {
//                            System.out.println("Pending Comment Document ID: " + document.getId() + ", Data: " + document.getData());
