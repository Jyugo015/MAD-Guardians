...
public class Tab3ReportedPostFragment extends BaseTab3Fragment<Helpdesk> implements RecycleViewReportedPostAdapter.OnReportedPostActionListener {
    ...
    protected List<Helpdesk> getData() {
        ...
        try {
            ...
            for (Helpdesk helpdesk : helpdeskList) {
                if (helpdesk.getHelpdeskStatus().equals("reviewed")){
