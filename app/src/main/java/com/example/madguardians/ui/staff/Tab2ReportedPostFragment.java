...
public class Tab2ReportedPostFragment extends BaseTab2Fragment<Helpdesk> implements RecycleViewReportedPostAdapter.OnReportedPostActionListener {
    ...
    public Tab2ReportedPostFragment() {
    ...
    protected List<Helpdesk> getData() {
        ...
        try {
            ...
            for (Helpdesk helpdesk : helpdeskList) {
                if (helpdesk.getHelpdeskStatus().equals("pending")){
