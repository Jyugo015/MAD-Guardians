...
////
////    @Override
////    protected void getDataAsync(OnDataLoadedCallback<List<VerEducator>> callback) {
////        // Execute Room query asynchronously
////        new Thread(() -> {
////            try {
////                List<VerEducator> educators = verEducatorDao.getAll();
////                requireActivity().runOnUiThread(() -> callback.onDataLoaded(educators));
////            } catch (Exception e) {
////                requireActivity().runOnUiThread(() -> callback.onError(e));
////            }
////        }).start();
////    }
//
...
////        return verEducatorDao.getAll();
////    }
//
//    @Override
//    protected List<VerEducator> getData() {
//        List<VerEducator>[] data = new List[1];
//        ExecutorService executor = Executors.newSingleThreadExecutor();
//
//        executor.execute(() -> {
//            AppDatabase database = AppDatabase.getDatabase(requireContext());
//            data[0] = database.verEducatorDao().getAll();
//        });
//        return data[0];
//    }
//
