...
public class Tab2EducatorFragment extends BaseTab2Fragment<VerEducator>
    ...
    private static final String TAG = "TAB2_EDUCATOR_FRAGMENT";
                ...
                .addSnapshotListener((queryDocumentSnapshots, e) -> {
                    ...
                    if (queryDocumentSnapshots != null && !queryDocumentSnapshots.isEmpty()) {
                        ...
                        for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                            ...
                            // Filter for "pending" verified status
                        ...
                        Log.d("FetchData", "No pending VerEducators found.");
                        showToast("No pending VerEducators found.");
                    }
                });
    }
