...
public class FirestoreManager {
    ...
    //documentId- autogenerated/attribute, to diffrentiate to use which method for inserting into firestore
//    From an Activity:
//    onInsertUpdate(tableName, documentId, currentChange, getApplicationContext());
//    From a Fragment:
//    onInsertUpdate(tableName, documentId, currentChange, requireContext().getApplicatio
    public void onInsertUpdate(String tableName, String documentId, Object currentChange, Context context) {
...
//            }
            ...
            if (documentId.equals("autogenerated")){
                firestore.collection(tableName).document(getDocumentId(tableName))
                        .set(currentChange)
    ...
    public void onDelete(String documentId, String tableName, Object deleteItem){
        try{
            deleteData(tableName, deleteItem);
            // Delete the post from Firestore
            if (getDocumentId(tableName)!= null){
                firestore.collection(tableName)
                        .document(documentId)
                        .delete()
    ...
    public String getDocumentId(String tableName){
        switch(tableName){
            case "user":
                return "userId";
            case "staff":
