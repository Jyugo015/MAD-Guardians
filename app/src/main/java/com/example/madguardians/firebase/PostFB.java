...
public class PostFB implements Serializable{
    ...
    public static void intializePosts() {
        ...
        hashMapList.add(createPostData("U0001",  "French 1",  "This is French 1",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00010",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00011",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00012",   FirebaseController.findStarting(FirebaseController.FOLDER) + "00001",  "11/12/2024"));
        hashMapList.add(createPostData("U0001",  "French 2",  "This is French 2",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00013",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00014",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00015",   FirebaseController.findStarting(FirebaseController.FOLDER) + "00001",  "11/12/2024"));
        hashMapList.add(createPostData("U0001",  "French 3",  "This is French 3",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00016",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00017",  FirebaseController.findStarting(FirebaseController.MEDIASET) + "00018",    FirebaseController.findStarting(FirebaseController.FOLDER) + "00001",  "11/12/2024"));
