...
public class RootCommentFragment extends DialogFragment {
...
////        if (context instanceof RootCommentListener) {
//        if (getParentFragment() instanceof RootCommentListener) {
//            listener = (RootCommentListener) getParentFragment();
//        } else {
//            throw new RuntimeException(getParentFragment().toString() + " must implement RootCommentListener");
//        }
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.comment_item_reply_root, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        commentText = view.findViewById(R.id.input_root_comment);
...
//        }
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String rootComment = commentText.getText().toString();
    ...
    public static RootCommentFragment newRootComment(PostFB post, String uncommitedComment) {
        RootCommentFragment fragment = new RootCommentFragment();
...
//            getDialog().getWindow().setBackgroundDrawableResource(android.R.color.transparent);
            ...
            EditText inputReply = getDialog().findViewById(R.id.input_root_comment);
            if (inputReply != null) {
